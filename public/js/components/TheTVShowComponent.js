...
methods: {
    ...
    filtertvshows(era){
        this.filteredMedia = this.retrievedMedia.filter(tvshow => tvshow.tvshows_era === (era));
    },
    
    filtertvshows(era){
        this.filteredMedia = this.retrievedMedia.filter(tvshow => tvshow.tvshows_era.includes(era));
    }
}
}